...
class Orchestrator:
    ...
    def build_system_prompt(self):
        ...
        DECISION RULES:
        1. If a tool exists for the request, return JSON: {{"action": "call_tool", "tool_name": "name", "params": {{...}}}}
        2. If NO tool exists, return JSON: {{"action": "suggest_new_tool", "requirement": "description of what is needed"}}
    ...
    def start(self):
        ...
        while True:
            ...
            decision = self.call_llm(user_input)
